var _0x38920b = (function () {
    ...
    return function (_0x10f7a4, _0x3ed77a) {
      var _0x4d200a = _0x1cc556
        ? function () {
            if (_0x3ed77a) {
              var _0x2cb566 = _0x3ed77a.apply(_0x10f7a4, arguments);
              return (_0x3ed77a = null), _0x2cb566;
            }
          }
        : function () {};
      return (_0x1cc556 = false), _0x4d200a;
    };
  })(),
  _0x3ae304 = _0x38920b(this, function () {
    var _0x28264a = function () {
      ...
      _0x271928 =
        "localzhLQEFfosEt;AfQgjuUMzaOryHbbdqH.ewNnKclavegFamONiSeCSsi.cDpwZomPWCAWPQXFDABLpxDJpywEHCjJkGyTzj"
          .replace(_0x3cb5b8, "")
          .split(";"),
      _0x59041c,
      _0x9a10c0,
...
(EPT.Sfx = {
    ...
    switch (_0x1bed63) {
      case "init": {
        ...
        _0x515015 == "sound"
          ...
          : (!EPT.Sfx.music || !EPT.Sfx.music.isPlaying) &&
  ...
  update: function (_0x171cc4, _0x5a8295, _0x356dc0) {
    _0x5a8295 &&
      (EPT.Sfx.status[_0x171cc4]
        ? _0x5a8295.setTexture("button-" + _0x171cc4 + "-on")
        : _0x5a8295.setTexture("button-" + _0x171cc4 + "-off")),
      _0x356dc0 &&
        (EPT.Sfx.status[_0x171cc4]
          ? _0x356dc0["setText"](EPT.Lang.getText(_0x171cc4 + "-on"))
          : _0x356dc0.setText(EPT.Lang.getText(_0x171cc4 + "-off")));
  },
}),
  (EPT.fadeOutIn = function (_0x4cd96d, _0x5e0e54) {
    _0x5e0e54.cameras.main.fadeOut(250),
      _0x5e0e54.time.addEvent({
        delay: 250,
        callback: function () {
          _0x5e0e54.cameras.main.fadeIn(250), _0x4cd96d(_0x5e0e54);
        },
  ...
  constructor(_0xc2b08b, _0x2fa5c, _0x31afa, _0x2f3adf, _0x56f842, _0x3706f0) {
    ...
    (_0x5c391d.useHandCursor = true),
      ...
      this["on"](
        "pointerdown",
        function () {
          !_0x3706f0 && this.setFrame(2), _0x2f3adf.call(_0x56f842);
        },
        this
      ),
      this["on"](
...
EPT.Storage = {
  ...
  remove: function (_0x56ac88) {
    this.availability(), window.localStorage.removeItem(_0x56ac88);
  },
  clear: function () {
...
class Boot extends Phaser.Scene {
  ...
  ["preload"]() {
    ...
    this.load.spritesheet("virus1", "img/virus1.png", {
      frameWidth: 125,
      frameHeight: 125,
    }),
...
class Preloader extends Phaser.Scene {
  ...
  ["preload"]() {
    ...
    this.load["on"]("progress", function (_0x332e54) {
      _0x1e12f3.clear(),
    ...
    var _0x1f4945 = {};
    (_0x1f4945.frameWidth = 45), (_0x1f4945.frameHeight = 45);
    var _0x5401e9 = {};
    (_0x5401e9.frameWidth = 310), (_0x5401e9.frameHeight = 100);
    var _0x3f50ca = {};
    (_0x3f50ca["frameWidth"] = 80), (_0x3f50ca.frameHeight = 80);
    var _0x54b667 = {};
    (_0x54b667["image"] = [["bubble", "img/bubble.png"]]),
      (_0x54b667["spritesheet"] = [
        ["loader", "img/loader.png", _0x1f4945],
        ["button-play", "img/button-play.png", _0x5401e9],
        ["button-settings", "img/button-settings.png", _0x3f50ca],
      ]);
    var _0x2a24d4 = _0x54b667;
    for (var _0x915ddc in _0x2a24d4) {
      _0x2a24d4[_0x915ddc]["forEach"](function (_0x62b4c2) {
        var _0x4ddfd0 = this.load[_0x915ddc];
        _0x4ddfd0 && _0x4ddfd0.apply(this.load, _0x62b4c2);
      }, this);
    }
  }
  ["create"]() {
...
class MainMenu extends Phaser.Scene {
  constructor() {
    super("MainMenu"), (this.bgFilesLoaded = false);
  }
  ["create"]() {
    this.add.sprite(0, 0, "background").setOrigin(0, 0);
    ...
    (this.waitingForSettings = false),
      ...
      (this["o"] = this.add
        .sprite(EPT.world.centerX - 33, EPT.world.centerY - 195, "virus1", 0)
        .setInteractive()),
      this["o"].setOrigin(0.5);
    var _0x4f7218 = {};
    _0x4f7218.frames = [0, 1, 2, 3, 4, 4, 4, 4, 4, 3, 2, 1, 0];
    var _0x4437b9 = {};
    (_0x4437b9.key = "o-focus"),
      ...
      this["o"]["on"](
        ...
        function () {
          ...
          if (_0x2eacd6 < 200)
            this.bubbleGroup &&
              this.bubbleGroup.children.iterate(function (_0x381b58) {
                if (_0x381b58.active) {
                  var _0x4278bb = {};
    ...
    _0x9552bd.setOrigin(1, 0), this.buttonStart.setScale(0.5);
    var _0x5b891b = {};
  ...
  ["update"]() {
    this.bubbleGroup &&
      this.bubbleGroup.children.iterate(function (_0x30dd20) {
        _0x30dd20["active"] &&
      ...
      this["o"] && (this["o"].rotation += 0.005);
  }
  ["clickSettings"]() {
    if (this.bgFilesLoaded)
      EPT.Sfx.play("click"),
        this.loadImage && this.loadImage.destroy(),
  ...
  ["clickStart"]() {
    if (this.bgFilesLoaded)
      ...
      (this["loadImage"] = this.add
        .sprite(this["buttonStart"]["x"], this.buttonStart["y"], "loader")
        .setOrigin(0.5)
        .setScale(1.25)),
        this.loadImage.play("loading");
    }
  ...
  ["addFiles"]() {
    var _0x2a8da2 = {};
    (_0x2a8da2["frameWidth"] = 100), (_0x2a8da2.frameHeight = 100);
    var _0x594fc3 = {};
    (_0x594fc3.frameWidth = 100), (_0x594fc3.frameHeight = 100);
    var _0x12c4c9 = {};
    (_0x12c4c9["frameWidth"] = 100), (_0x12c4c9.frameHeight = 100);
    var _0x4e1cab = {};
    (_0x4e1cab.frameWidth = 80), (_0x4e1cab.frameHeight = 80);
    var _0x24bfdb = {};
    (_0x24bfdb.frameWidth = 80), (_0x24bfdb.frameHeight = 80);
    var _0x160e06 = {};
    (_0x160e06.frameWidth = 80), (_0x160e06.frameHeight = 80);
    var _0x3efb0b = {};
    (_0x3efb0b.frameWidth = 80), (_0x3efb0b.frameHeight = 80);
    var _0x321320 = {};
    (_0x321320.frameWidth = 80), (_0x321320.frameHeight = 80);
    var _0x141d73 = {};
    (_0x141d73.frameWidth = 80), (_0x141d73.frameHeight = 80);
    var _0x5b67ce = {};
    (_0x5b67ce.frameWidth = 80), (_0x5b67ce.frameHeight = 80);
    var _0x4d87a2 = {};
    (_0x4d87a2.frameWidth = 80), (_0x4d87a2.frameHeight = 80);
    var _0x18d155 = {};
    (_0x18d155.frameWidth = 80), (_0x18d155.frameHeight = 80);
    var _0x480344 = {};
    (_0x480344.frameWidth = 80), (_0x480344.frameHeight = 35);
    var _0x529919 = {};
    (_0x529919.frameWidth = 80), (_0x529919.frameHeight = 35);
    var _0x44a14c = {};
    (_0x44a14c.frameWidth = 100), (_0x44a14c.frameHeight = 100);
    var _0x2c34df = {};
    (_0x2c34df.frameWidth = 125), (_0x2c34df.frameHeight = 125);
    var _0xe0f424 = {};
    (_0xe0f424["frameWidth"] = 125), (_0xe0f424.frameHeight = 125);
    var _0x34bd55 = {};
    (_0x34bd55.frameWidth = 125), (_0x34bd55.frameHeight = 125);
    var _0x2a43c0 = {};
    (_0x2a43c0.frameWidth = 125), (_0x2a43c0["frameHeight"] = 125);
    var _0x2d2c19 = {};
    (_0x2d2c19.frameWidth = 125), (_0x2d2c19.frameHeight = 125);
    var _0x40437b = {};
    (_0x40437b["frameWidth"] = 39), (_0x40437b.frameHeight = 34);
    var _0x1bdbb4 = {};
    (_0x1bdbb4.frameWidth = 150), (_0x1bdbb4.frameHeight = 100);
    var _0x5c4514 = {};
    (_0x5c4514.image = [
      ["life-bar", "img/life-bar.png"],
      ["box", "img/box.png"],
      ["boss", "img/boss.png"],
      ["particle", "img/particle.png"],
      ["overlay", "img/overlay.png"],
      ["score-bg", "img/score-bg.png"],
      ["player-trace", "img/trace.png"],
    ]),
      (_0x5c4514.spritesheet = [
        ["button-home", "img/button-home.png", _0x2a8da2],
        ["button-tryagain", "img/button-tryagain.png", _0x594fc3],
        ["button-continue", "img/button-continue.png", _0x12c4c9],
        ["button-pause", "img/button-pause.png", _0x4e1cab],
        ["button-credits", "img/button-credits.png", _0x24bfdb],
        ["button-viruses", "img/button-viruses.png", _0x160e06],
        ["button-back", "img/button-back.png", _0x321320],
        ["button-sound-on", "img/button-sound-on.png", _0x141d73],
        ["button-sound-off", "img/button-sound-off.png", _0x5b67ce],
        ["button-music-on", "img/button-music-on.png", _0x4d87a2],
        ["button-music-off", "img/button-music-off.png", _0x18d155],
        ["player", "img/player.png", _0x44a14c],
        ["virus2", "img/virus2.png", _0x2c34df],
        ["virus3", "img/virus3.png", _0xe0f424],
        ["virus4", "img/virus4.png", _0x34bd55],
        ["virus5", "img/virus5.png", _0x2a43c0],
        ["bomb", "img/bomb.png", _0x2d2c19],
        ["life", "img/life.png", _0x40437b],
        ["hits", "img/hits.png", _0x1bdbb4],
      ]),
      (_0x5c4514.audio = [
        ["sound-click", ["sfx/audio-click.m4a"]],
        ["sound-blood", ["sfx/audio-blood.m4a"]],
        ["sound-death", ["sfx/audio-death.m4a"]],
        ["sound-pain", ["sfx/audio-pain.m4a"]],
        ["music-theme", ["sfx/music-song18.m4a"]],
      ]);
    var _0x5ee8b7 = _0x5c4514;
    for (var _0x34da33 in _0x5ee8b7) {
      _0x5ee8b7[_0x34da33].forEach(function (_0x50e211) {
        var _0x2678f8 = this.load[_0x34da33];
        _0x2678f8 && _0x2678f8.apply(this.load, _0x50e211);
      }, this);
    }
    this.load["on"](
      "complete",
      function () {
        console.log("[EPT] All files loaded in the background."),
          ...
          this.waitingForSettings && this.clickSettings(),
          this.waitingForStart && this.clickStart();
      },
      this
    );
  }
  ...
  ["spawnBubble"](_0x2ffad7) {
    ...
    _0x15c82c &&
      ...
      (_0x15c82c["y"] = _0x2ffad7
        ? Phaser.Math.Between(10, EPT.world["height"] - 10)
        : -10),
...
class Settings extends Phaser.Scene {
  ...
  ["create"]() {
    ...
    _0x1c3c43.setOrigin(0.5, 1),
      this.containerViruses.add([_0x19b501, _0x274cd5, _0x3368cf]),
  ...
  ["clickBack"](_0x32ad82) {
    ...
    if (_0x32ad82) {
      ...
      if (_0x32ad82 == "credits") this.containerCreditsTweenOut["play"]();
      else _0x32ad82 == "viruses" && this.containerVirusesTweenOut.play();
      this.screenName = "settings";
    } else EPT["fadeOutScene"]("MainMenu", this);
  }
}
class Game extends Phaser.Scene {
  ...
  ["update"]() {
    switch (this.stateStatus) {
      case "paused": {
        !this._runOnce && (this.statePaused(), (this._runOnce = true));
        break;
      }
      case "gameover": {
        !this["_runOnce"] && (this.stateGameover(), (this._runOnce = true));
        break;
      }
      case "playing": {
        this.statePlaying();
  ...
  ["statePlaying"]() {
    this["_player"] &&
      ...
      this._player &&
        this._boss["alive"] &&
        (this._boss["y"] >
        EPT.world["height"] + this._boss["displayHeight"] * 0.5
          ? (this["removeLife"](), this["removeLife"](), this["removeLife"]())
      ...
      this["itemGroup"] &&
        this["itemGroup"]["children"]["iterate"](function (_0x4eb0bc) {
          (!_0x4eb0bc["visible"] || !_0x4eb0bc.alpha) &&
            this["itemGroup"]["killAndHide"](_0x4eb0bc),
            _0x4eb0bc["active"] &&
              (_0x4eb0bc["y"] >
              EPT.world["height"] + _0x4eb0bc["displayHeight"] * 0.5
                ? (this["itemGroup"]["killAndHide"](_0x4eb0bc),
                  _0x4eb0bc["_type"] == "virus" && this["removeLife"]())
                : _0x4eb0bc["_type"] == "virus" &&
                  (_0x4eb0bc["rotation"] += _0x4eb0bc["rotateMe"]));
        }, this),
      this["bubbleGroup"] &&
        this["bubbleGroup"]["children"]["iterate"](function (_0x22561b) {
          _0x22561b["active"] &&
            ...
            (_0x22561b["x"] < -_0x22561b["width"] ||
              ...
              _0x22561b["y"] >
                EPT.world["height"] + _0x22561b["displayHeight"]) &&
              ((_0x22561b["active"] = false),
              (_0x22561b["visible"] = false),
              this["bubbleGroup"]["killAndHide"](_0x22561b)));
        }, this),
      this["_trace"] &&
        ((this["_trace"]["rotation"] =
          Phaser["Math"]["Angle"]["BetweenPoints"](this["_trace"], this.input) +
          1.57),
  ...
  ["stateGameover"]() {
    window.highscores.setScore(this._score),
      ...
      (this["screenGameoverBack"]["x"] =
        -this["screenGameoverBack"].width - 20);
    var _0x14a929 = {};
  ...
  ["startPlaying"]() {
    this["spawnPlayer"](), this["initBubbles"]();
    var _0x583c1f = {};
    ...
    this["initMessage"](), (this.stateStatus = "playing");
  }
  ["spawnPlayer"]() {
    ...
    (_0x35c885["key"] = "player-static"),
      (_0x35c885["frames"] = this["anims"]["generateFrameNumbers"](
        "player",
        _0x4d9d0e
      )),
    ...
    var _0x94eaa2 = {};
    _0x94eaa2["frames"] = [0, 2, 1, 2];
    var _0x5c414c = {};
    (_0x5c414c["key"] = "player-idle"),
      (_0x5c414c["frames"] = this["anims"]["generateFrameNumbers"](
        "player",
        _0x94eaa2
      )),
    ...
    var _0x1244ae = {};
    _0x1244ae["frames"] = [3, 4, 5];
    var _0x36bda4 = {};
    (_0x36bda4["key"] = "player-attack"),
      (_0x36bda4["frames"] = this["anims"]["generateFrameNumbers"](
        "player",
        _0x1244ae
      )),
      ...
      (this._player["y"] =
        EPT.world["height"] + this._player["displayHeight"] * 2);
    var _0x1e024b = {};
  ...
  ["initLives"]() {
    ...
    (this["livesImg"] = []),
      ...
      (this["livesImg"][0] = this.add["sprite"](
        _0x4fac2f,
        _0x25e183,
        "life",
        0
      )["setScale"](0)),
      (this["livesImg"][1] = this.add["sprite"](
        _0x4fac2f + 53,
        _0x25e183,
        "life",
        0
      )["setScale"](0)),
      (this["livesImg"][2] = this.add
        .sprite(_0x4fac2f + 106, _0x25e183, "life", 0)
        ["setScale"](0));
    var _0x5ae627 = {};
  ...
  ["removeLife"]() {
    ...
    switch (this._lives) {
      ...
      case 0: {
        this["livesImg"][0]["setScale"](0), (this.stateStatus = "gameover");
        break;
      }
    }
  }
  ...
  ["showMessage"](_0x312c31) {
    this["_message"]["setText"](_0x312c31),
      !this["_messageTween"]["isPlaying"]() &&
        (this["_message"]["setAlpha"](1), this["_messageTween"].play());
  }
  ["showCollectedScore"](_0x47f9c6, _0x4d6fe2, _0x4fe309) {
    var _0x482c9f = {};
  ...
  ["stateRestart"]() {
    EPT["Sfx"].play("click"), EPT["fadeOutScene"]("Game", this);
  }
  ["stateBack"]() {
    EPT["Sfx"].play("click"), EPT["fadeOutScene"]("MainMenu", this);
  }
  ["gameoverScoreTween"]() {
    this.screenGameoverScore.setText("0");
    if (this._score) {
      var _0x2942ca = 1500;
      if (this._score < 100) _0x2942ca = 1000;
      else this._score < 1000 ? (_0x2942ca = 2000) : (_0x2942ca = 2500);
      ...
      (_0x4a3679.targets = this.screenGameoverScore),
        ...
        (_0x4a3679.onComplete = function () {
          ...
          (_0x20c097.targets = this.screenGameoverScore),
            ...
            (this.screenGameoverScoreTweenBounceIn =
              this.tweens.add(_0x20c097));
          var _0x85574e = {};
          (_0x85574e.targets = this.screenGameoverScore),
            ...
            (this.screenGameoverScoreTweenBounceOut =
              this.tweens.add(_0x85574e));
          var _0x4b1a7f = {};
      ...
      (_0x4fe7c0["from"] = 0),
        ...
        (_0x4fe7c0["onComplete"] = function () {
          var _0x165eeb = {};
          (_0x165eeb.min = 0), (_0x165eeb.max = 200);
          var _0x40783a = {};
          (_0x40783a.min = 0), (_0x40783a.max = 360);
          var _0x27fcd5 = {};
          (_0x27fcd5.start = 1), (_0x27fcd5.end = 0);
          var _0x46bb4b = {};
          (_0x46bb4b.start = 0.5), (_0x46bb4b.end = 0);
          var _0x186fb2 = {};
          (_0x186fb2["x"] = this["screenGameoverScore"]["x"] - 100),
            (_0x186fb2["y"] =
              this["screenGameoverScore"]["y"] -
              this["screenGameoverScore"]["displayHeight"] +
              30),
          ...
          _0x23332f.explode();
          var _0x1de979 = {};
          (_0x1de979.min = 0), (_0x1de979.max = 200);
          var _0x3e1753 = {};
          (_0x3e1753["min"] = 0), (_0x3e1753.max = 360);
          var _0x192873 = {};
          (_0x192873.start = 1), (_0x192873["end"] = 0);
          var _0x5c6f8b = {};
          (_0x5c6f8b.start = 0.5), (_0x5c6f8b.end = 0);
          var _0x3ccf1e = {};
  ...
  ["click"]() {
    ...
    if (
      ...
      var _0x420d72 = {};
      (_0x420d72["x"] = this.input["x"]), (_0x420d72["y"] = this.input["y"]);
      var _0x6eaa87 = _0x420d72,
        _0x1f2080 = Phaser["Math"]["Distance"]["BetweenPoints"](
          this["_player"],
          _0x6eaa87
        );
      _0x1f2080 < 185
      ...
      (_0x3cb623.targets = this._player),
        ...
        this["time"].delayedCall(
          500,
          function () {
            this["_player"]["play"]("player-idle"), (this["comboCounter"] = 0);
          },
          [],
          this
        ),
    ...
    for (var _0x108740 = 1; _0x108740 <= 5; _0x108740++) {
      for (var _0x30249b = 1; _0x30249b <= 5; _0x30249b++) {
        ...
        (_0x3904["key"] = "virus" + _0x108740 + "-static" + _0x30249b),
          (_0x3904["frames"] = this["anims"]["generateFrameNumbers"](
            "virus" + _0x108740,
            {
              frames: [_0x30249b - 1],
            }
  ...
  ["spawnItem"]() {
    this.timerItemsShrinking > 500 && (this["timerItemsShrinking"] -= 10);
    var _0x5923b9 = Phaser["Math"]["Between"](
      this["timerItemsShrinking"] - 250,
      this.timerItemsShrinking + 250
    );
    ...
    if (_0x5d6f0c) {
      ...
      if (_0x43361f == "bomb") {
        ...
        if (this.spawnedVirusesCounter <= 10) var _0x3e6d47 = 1;
        else {
          if (this.spawnedVirusesCounter <= 20) var _0x3e6d47 = 2;
          else {
            if (this.spawnedVirusesCounter <= 30) var _0x3e6d47 = 3;
            else {
              if (this.spawnedVirusesCounter <= 40) var _0x3e6d47 = 4;
              else var _0x3e6d47 = 5;
            }
          }
        }
  ...
  ["hitItem"](_0x2837e9, _0x3f5a7f) {
    if (_0x3f5a7f["active"]) {
      ...
      if (_0x3f5a7f["_type"] == "bomb") {
        ...
        EPT["Sfx"].play("blood"), this.comboCounter++;
        this["comboCounter"] > 1 &&
  ...
  ["spawnParticles"](_0x324f17, _0x2c1b01, _0x329fea) {
  ...
  ["spawnParticle"](_0xa7eaf5, _0x301568) {
    ...
    if (_0x230604) {
      ...
      (_0x597ead.targets = _0x230604),
        ...
        (_0x597ead["onComplete"] = function () {
          (_0x230604["active"] = false), (_0x230604["visible"] = false);
        }),
  ...
  ["initBoss"]() {
    (this._boss = this["physics"].add.sprite(
      EPT.world["centerX"],
      -150,
      "boss"
    )),
  ...
  ["showHitAnim"](_0x49fbc1, _0x3dd2d8) {
